...
def parse_args():
    ...
    parser.add_argument('--train_episode', default=400, type=int, help='train iters each timestep')
    ...
    parser.add_argument('--data_bsize', default=8, type=int, help='number of data batch size')
...
def get_model_and_checkpoint(model, dataset, checkpoint_path, n_gpu=0):
    if model == 'mobilenet' and dataset == 'imagenet':
        from models.mobilenet import MobileNet
        net = MobileNet(n_class=10) # 1000 classes for the normal imagenet, 10 for subset imagenette
    elif model == 'mobilenetv2' and dataset == 'imagenet':
        from models.mobilenet_v2 import MobileNetV2
        net = MobileNetV2(n_class=1000)
    elif model == 'yolov3tiny' and dataset == 'imagenet':
        from models.yolov3tiny import Darknet
        net = Darknet()
    else:
